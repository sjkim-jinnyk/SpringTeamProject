							...
							<div class="block">
								<div class="below">
									...
									<c:if test="${!empty dto.getReview_img()}">
										<a href="<%=request.getContextPath() %>/review_cont.do?no=${dto.getReview_no()}"><img class="pro_img" src="resources/img/review/${dto.getReview_img() }"></a>
									</c:if>
									
									<c:if test="${empty dto.getReview_img()}">
										<a href="<%=request.getContextPath() %>/review_cont.do?no=${dto.getReview_no()}"><img class="pro_img" src="resources/img/review/review_sample.jpeg"></a>
									</c:if>
