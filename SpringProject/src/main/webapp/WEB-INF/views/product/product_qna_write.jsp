	...
	<div class="product-qna-form">
							...
							<form method="post">
								...
								<div class="history">
									...
									<div class="pro-content">
										...
										<a href="<%=request.getContextPath() %>/product_cont.do?no=${dto.getPro_no()}">${dto.getPro_name() }</a>
									</div>
									
									<div class="pro-price">
										<fmt:formatNumber value="${dto.getPro_output_price() }" /> 원
									</div>
								</div>
							</form>
							</li>
		...
		<form action="product_qna_write_ok.do">
			...
			<table border="1">
				...
				<tr>
					<th>내 용</th>
					<td><textarea name="qna_cont" rows="8" cols="50" placeholder="문의하실 내용을 입력하세요." required></textarea></td>
				</tr>
				<tr>
					<th>비공개</th>
