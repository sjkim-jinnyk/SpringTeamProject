...
<title>울퉁불퉁's - 상품 Q&A 수정하기</title>
</head>
	...
	<div class="product-qna-form">
		...
		<form action="product_qna_modify_ok.do">
			...
			<table class="qna-form">
				...
				<tr>
					<th>내용</th>
					<td><textarea name="qna_cont" rows="8" required>${qdto.getQna_cont() }</textarea></td>
				</tr>
				<tr>
					<th>비밀글</th>
					<td>
				...
				<tr>
					<td colspan="2">
						...
						<input class="qna-form-btn form-submit" type="submit" value="수정">
					</td>
				</tr>
			</table>
		</form>
